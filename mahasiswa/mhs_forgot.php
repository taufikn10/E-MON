...
if (isset($_POST["email"])) {
  ...
  $result = mysqli_query($conn, "SELECT * FROM tb_bio_mhs WHERE email_mhs = '$emailTo' ");
  ...
  if (mysqli_num_rows ($result) === 1) {
    ...
    $query = "INSERT INTO tb_reset_mhs(code, id_mhs, otp) VALUES('$code', '".$row["id_mhs"]."', '$otp')";
    ...
    //Content
    $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/mhs_uppass.php?code=$code";
    ...
    document.location.href = 'mhs_forgot.php';
    </script>";
}
exit();
}
    ...
    <div class="col-lg-8 col-md-10">
      ...
      <form class="card mt-4" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-footer text-center">
          ...
          <a href="mhs_login.php" class="btn btn-back">Back Login</a>
        </div>
      </form>
    </div>
  </div>
